...
\begin{ressection}{Experiences}
	\begin{ressubsec}{Embedded Software Architect}{Thales Herstal}{Herstal, Belgium}{12/2025--present}
		\ressubitem{Embedded Software Architect Rockets/Launchers/Ground Support Equipment}
		\ressubitem{Real-Time, Bare-metal, DSP}
		\ressubitem{C, embedded, FreeRTOS, lwIP}
		\ressubitem{Defense}
	\end{ressubsec}
	\begin{ressubsec}{Senior Consultant}{Verotech}{Haasrode, Belgium}{09/2012--12/2025}
        \begin{ressubsubsec}{Software Architect}{JCD}{Loncin, Belgium}{09/2021--12/2025}
            \ressubsubitem{Embedded software architect}
            \ressubsubitem{Team Coach Modern C++}
            \ressubsubitem{Responsible Ballistics}
            \ressubsubitem{EtherCAT}
            \ressubsubitem{Embedded Real-Time Linux}
